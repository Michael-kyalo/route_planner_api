...
final $typed_data.Uint8List activityDescriptor = $convert.base64Decode('CghBY3Rpdml0eRIWCgZ0cmlwSWQYASABKAlSBnRyaXBJZBIOCgJpZBgCIAEoCVICaWQSFgoGc3RhdHVzGAMgASgFUgZzdGF0dXMSFAoFdGl0bGUYBCABKAlSBXRpdGxlEhsKBWNvc3RzGAUgAygLMgUuQ29zdFIFY29zdHM=');
...
final $typed_data.Uint8List costDescriptor = $convert.base64Decode('CgRDb3N0Eh4KCmFjdGl2aXR5SWQYASABKAlSCmFjdGl2aXR5SWQSDgoCaWQYAiABKAlSAmlkEhQKBXRvdGFsGAMgASgFUgV0b3RhbBIUCgV0aXRsZRgEIAEoCVIFdGl0bGUSIAoLZGVzY3JpcHRpb24YBSABKAlSC2Rlc2NyaXB0aW9u');
...
final $typed_data.Uint8List tripTagDescriptor = $convert.base64Decode('CgdUcmlwVGFnEhYKBnRyaXBJZBgBIAEoCVIGdHJpcElkEg4KAmlkGAIgASgJUgJpZBIUCgV0aXRsZRgDIAEoCVIFdGl0bGU=');
...
final $typed_data.Uint8List tripPhotoDescriptor = $convert.base64Decode('CglUcmlwUGhvdG8SFgoGdHJpcElkGAEgASgJUgZ0cmlwSWQSDgoCaWQYAiABKAlSAmlkEhAKA3VybBgDIAEoCVIDdXJsEhgKB2NhcHRpb24YBCABKAlSB2NhcHRpb24=');
...
final $typed_data.Uint8List tripDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List tripRequestDescriptor = $convert.base64Decode('CgtUcmlwUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQ=');
